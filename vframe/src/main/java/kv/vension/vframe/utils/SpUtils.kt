...
object SpUtils {
    ...
    val appSp: SharedPreferences
        get() = AbsApplication.appContext.getSharedPreferences(sp_name, Context.MODE_PRIVATE)
     ...
     */
    fun removeAll() {
        val sp = AbsApplication.appContext.getSharedPreferences(sp_name, Activity.MODE_PRIVATE)
        sp.edit().clear().apply()
    }
