package com.vension.fastframe.module_news.widget.refresh.ypx_refreshlayout;
...
public class YPXQQRefreshView extends YPXRefreshBaseView {
    ...
    public void refreshFailed() {
        ...
        tv_ok.setText("刷新失败");
        iv_ok.setImageDrawable(getResources().getDrawable(R.drawable.pull_failure));
    }
    ...
    public void refreshOK() {
        ...
        ll_ok.setVisibility(View.VISIBLE);
        tv_ok.setText("刷新成功");
        iv_ok.setImageDrawable(getResources().getDrawable(R.drawable.pull_ok));
    }
