 ...
 */
public class HomeHottopMultipleRecycleAdapter extends
        BaseMultiItemQuickAdapter<HomeTophotIndex.Articles, BaseViewHolder>
    ...
    public HomeHottopMultipleRecycleAdapter(Context context, List<HomeTophotIndex.Articles> data) {
        ...
        Logger.e("HomeHottopMultipleRecycleAdapter-->create");
    ...
    protected void convert(BaseViewHolder helper, HomeTophotIndex.Articles articles) {
        ...
        Logger.e("convert-->" + articles.getItemType());
...
//        mBanner.setBannerStyle()
        ...
        mImageLoader.displayImage(mContext, NewsConstant.HOME_MENU_URL_A,helper.getView(R.id.menu_a));
        mImageLoader.displayImage(mContext, NewsConstant.HOME_MENU_URL_B,helper.getView(R.id.menu_b));
        mImageLoader.displayImage(mContext, NewsConstant.HOME_MENU_URL_C,helper.getView(R.id.menu_c));
        mImageLoader.displayImage(mContext, NewsConstant.HOME_MENU_URL_D,helper.getView(R.id.menu_d));
        mImageLoader.displayImage(mContext, NewsConstant.HOME_MENU_URL_E,helper.getView(R.id.menu_e));
    }
    ...
    private void bindSingleNewsData(BaseViewHolder helper, HomeTophotIndex.Articles item, int position) {
        ...
        mImageLoader.displayImage(mContext, item.getPics().get(0).url,helper.getView(R.id.article_img));
...
//                HotNewsDetailActivity.newInstance(context, item.articleUrl == null ? "" : item.articleUrl);
    ...
    private void bindSingleBigNewsData(BaseViewHolder helper, HomeTophotIndex.Articles item, int adapterPosition) {
        ...
        mImageLoader.displayImage(mContext,item.getPics().get(0).url,helper.getView(R.id.img_single_big));
...
//                HotNewsDetailActivity.newInstance(context, item.articleUrl == null ? "" : item.articleUrl);
    ...
    private void bindTYAdImageData(BaseViewHolder helper, HomeTophotIndex.Articles item, int adapterPosition) {
        if (item.getPics().size() >= 3) {
            mImageLoader.displayImage(mContext,item.getPics().get(0).url,helper.getView(R.id.tymenu_a));
            mImageLoader.displayImage(mContext,item.getPics().get(1).url,helper.getView(R.id.tymenu_b));
            mImageLoader.displayImage(mContext,item.getPics().get(2).url,helper.getView(R.id.tymenu_c));
        }
    }
    ...
    private void bindMultiImgNewsData(BaseViewHolder helper, HomeTophotIndex.Articles item, int position) {
        LinearLayout view = helper.getView(R.id.llContent);
        if (item.getPics().size() >= 3) {
            mImageLoader.displayImage(mContext,item.getPics().get(0).url,helper.getView(R.id.article_img1));
            mImageLoader.displayImage(mContext,item.getPics().get(1).url,helper.getView(R.id.article_img2));
            mImageLoader.displayImage(mContext,item.getPics().get(2).url,helper.getView(R.id.article_img3));
        }
...
//                HotNewsDetailActivity.newInstance(context, item.articleUrl == null ? "" : item.articleUrl);
    ...
    private void bindHorizaontalImgNewsData(BaseViewHolder helper, HomeTophotIndex.Articles item, int adapterPosition) {
        ...
        ((ImageView) helper.getView(R.id.hotNewsTitleIco)).setImageResource(R.drawable.icon_title_hotnews);
...
//            titleTextView.setLayoutParams(p);
        ...
        params.height = (int) (params.width * 9f / 16f);
        mVideoPlayer.setLayoutParams(params);
        mImageLoader.displayImage(mContext,articles.getPics().get(0).url,mVideoPlayer.thumbImageView);
    }
