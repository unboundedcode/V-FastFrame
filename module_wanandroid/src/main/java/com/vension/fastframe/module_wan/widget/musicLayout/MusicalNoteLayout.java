package com.vension.fastframe.module_wan.widget.musicLayout;
...
public class MusicalNoteLayout extends RelativeLayout implements WeakWrapperHandler.MessageHandler {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int defaultSize = DensityUtil.INSTANCE.dp2px(getContext(), DEFAULT_MUSIC_VIEW_SIZE);
        int musicViewSize;
        ...
        params.rightMargin = DensityUtil.INSTANCE.dp2px(getContext(), 10);
        params.bottomMargin = DensityUtil.INSTANCE.dp2px(getContext(), 25);
